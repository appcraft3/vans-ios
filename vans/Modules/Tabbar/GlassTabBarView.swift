...
struct GlassTabBarView: View {
    ...
    let tabs: [TabItem] = [
        .init(id: 0, title: String(localized: "Home"), systemImage: "house.fill"),
        .init(id: 1, title: String(localized: "Explore"), systemImage: "magnifyingglass"),
        .init(id: 2, title: String(localized: "Profile"), systemImage: "person.circle")
    ]
    ...
    private var inactiveColor: Color { .white.opacity(0.5) }
    ...
    var body: some View {
        ZStack {
            BlurView(style: .systemUltraThinMaterialDark)
                ...
                .shadow(color: .black.opacity(0.8), radius: 30, y: 16)
                    ...
                    Button {
                        ...
                        VStack(spacing: 6) {
                            ...
                            Text(tab.title)
                                ...
                                .foregroundStyle(selectedIndex == tab.id ? .white : inactiveColor)
                                .frame(height: 16)
                        }
